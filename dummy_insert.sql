...
('CSE', 'Academic Bhaban-1', 500000.00),
...
('Karim', 'Hossain', 'hash2', 'ECO'),
('Sumaiya', 'Akter', 'hash3', 'MPS'),
('Nusrat', 'Jahan', 'hash4', 'MPS'),
('Mehedi', 'Hasan', 'hash5', 'CSE'),
('Taslima', 'Begum', 'hash6', 'ECO'),
('Fahim', 'Khan', 'hash7', 'MPS'),
('Sabbir', 'Rahman', 'hash8', 'MPS');
